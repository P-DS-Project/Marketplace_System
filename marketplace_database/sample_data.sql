...
-- Admin login: admin@marketplace.com / admin12345
INSERT INTO users (user_id, username, email, password_hash, salt, role, avatar_url, is_active, is_verified, created_at, updated_at) VALUES
  ( 1, 'ahmed_hassan',   'ahmed.hassan@gmail.com',      '$2b$12$LQv3c1yqBWVHxkd0LHAkCOYz6TtxMqJqhcanFp8gL9ZiHs1RzFi7e', 'a1b2c3d4e5f6g7h8', 'USER',           'https://cdn.marketplace.com/avatars/1.jpg',  TRUE, TRUE,  '2025-01-05 09:00:00', '2025-03-10 14:22:00'),
  ( 2, 'sara_ibrahim',   'sara.ibrahim@yahoo.com',       '$2b$12$Km8nPqRsT1uVwXyZ2AbCdEfGhIjKlMnOpQrStUvWxYz3456789012', 'b2c3d4e5f6g7h8i9', 'USER',           'https://cdn.marketplace.com/avatars/2.jpg',  TRUE, TRUE,  '2025-01-10 11:30:00', '2025-04-01 08:15:00'),
  ( 3, 'mo_ali',         'mohamed.ali@hotmail.com',      '$2b$12$XyZ1AbCdEfGhIjKlMnOpQrStUvWxYz34567890123456789012345', 'c3d4e5f6g7h8i9j0', 'USER',           NULL,                                         TRUE, FALSE, '2025-01-15 16:45:00', '2025-01-15 16:45:00'),
  ( 4, 'nour_khalil',    'nour.khalil@gmail.com',        '$2b$12$AbCdEfGhIjKlMnOpQrStUvWxYz3456789012345678901234567890', 'd4e5f6g7h8i9j0k1', 'USER',           'https://cdn.marketplace.com/avatars/4.jpg',  TRUE, TRUE,  '2025-02-01 10:00:00', '2025-05-10 09:30:00'),
  ( 5, 'kareem_m',       'kareem.mansour@outlook.com',   '$2b$12$BcDeFgHiJkLmNoPqRsTuVwXyZ12345678901234567890123456789', 'e5f6g7h8i9j0k1l2', 'USER',           'https://cdn.marketplace.com/avatars/5.jpg',  TRUE, TRUE,  '2025-02-14 13:20:00', '2025-06-01 11:00:00'),
  ( 6, 'layla_farouk',   'layla.farouk@gmail.com',       '$2b$12$CdEfGhIjKlMnOpQrStUvWxYz123456789012345678901234567890', 'f6g7h8i9j0k1l2m3', 'USER',           'https://cdn.marketplace.com/avatars/6.jpg',  TRUE, TRUE,  '2025-02-20 08:00:00', '2025-04-15 17:45:00'),
  ( 7, 'omar_samir',     'omar.samir@yahoo.com',         '$2b$12$DeFgHiJkLmNoPqRsTuVwXyZ1234567890123456789012345678901', 'g7h8i9j0k1l2m3n4', 'USER',           NULL,                                         TRUE, FALSE, '2025-03-01 12:00:00', '2025-03-01 12:00:00'),
  ( 8, 'dina_youssef',   'dina.youssef@gmail.com',       '$2b$12$EfGhIjKlMnOpQrStUvWxYz12345678901234567890123456789012', 'h8i9j0k1l2m3n4o5', 'USER',           'https://cdn.marketplace.com/avatars/8.jpg',  TRUE, TRUE,  '2025-03-05 15:30:00', '2025-06-10 10:00:00'),
  ( 9, 'tarek_naguib',   'tarek.naguib@hotmail.com',     '$2b$12$FgHiJkLmNoPqRsTuVwXyZ123456789012345678901234567890123', 'i9j0k1l2m3n4o5p6', 'USER',           'https://cdn.marketplace.com/avatars/9.jpg',  TRUE, TRUE,  '2025-03-12 07:45:00', '2025-05-20 13:30:00'),
  (10, 'hana_rezk',      'hana.rezk@gmail.com',          '$2b$12$GhIjKlMnOpQrStUvWxYz1234567890123456789012345678901234', 'j0k1l2m3n4o5p6q7', 'USER',           'https://cdn.marketplace.com/avatars/10.jpg', TRUE, TRUE,  '2025-03-18 09:15:00', '2025-06-05 16:20:00'),
  (11, 'techzone_store', 'youssef.store@techzone.com',   'dkEOAj/fxSx2HUIglgUhhza6kthRPZjFw2N4nqADb9A=', 'k1l2m3n4o5p6q7r8', 'EXTERNAL_STORE', 'https://cdn.marketplace.com/avatars/11.jpg', TRUE, TRUE,  '2024-11-01 10:00:00', '2025-06-01 09:00:00'),
  (12, 'menna_boutique', 'menna.boutique@fashion.eg',    '$2b$12$IjKlMnOpQrStUvWxYz123456789012345678901234567890123456', 'l2m3n4o5p6q7r8s9', 'EXTERNAL_STORE', 'https://cdn.marketplace.com/avatars/12.jpg', TRUE, TRUE,  '2024-11-15 14:00:00', '2025-05-15 11:30:00'),
  (13, 'admin_main',     'admin@marketplace.com',        'TeEf8lN2puv+4chyMfHZbhz87oc9JSNvbM8loeAzctw=',                'm3n4o5p6q7r8s9t0', 'ADMIN',          'https://cdn.marketplace.com/avatars/13.jpg', TRUE, TRUE,  '2024-10-01 08:00:00', '2025-06-01 08:00:00'),
  (14, 'ramy_electronics','ramy.electronics@shop.eg',    '$2b$12$KlMnOpQrStUvWxYz12345678901234567890123456789012345678', 'n4o5p6q7r8s9t0u1', 'EXTERNAL_STORE', 'https://cdn.marketplace.com/avatars/14.jpg', TRUE, TRUE,  '2024-12-01 10:00:00', '2025-05-01 10:00:00'),
  (15, 'salma_crafts',   'salma.crafts@etsy.eg',         '$2b$12$LmNoPqRsTuVwXyZ123456789012345678901234567890123456789', 'o5p6q7r8s9t0u1v2', 'EXTERNAL_STORE', 'https://cdn.marketplace.com/avatars/15.jpg', TRUE, TRUE,  '2025-01-20 11:00:00', '2025-04-10 14:00:00');
...
INSERT INTO products (product_id, seller_id, category_id, name, brand, description, price, image_url, status, created_at, updated_at) VALUES
  ...
  ( 1, 11, 1, 'Samsung Galaxy S25 Ultra 512GB',           'Samsung',  'Flagship smartphone with 200MP camera, S-Pen, 5000mAh battery, AI features.', 45999.00, 'https://images.unsplash.com/photo-1610945265064-0e34e5519bbf?w=600',  'IN_STOCK', '2025-02-01 10:00:00', '2026-04-15 12:00:00'),
  ( 2, 11, 1, 'MacBook Pro M4 14-inch 16GB/512GB',        'Apple',    'Professional laptop with M4 chip, Liquid Retina XDR display, 18-hr battery.',  89999.00, 'https://images.unsplash.com/photo-1517336714731-489689fd1ca8?w=600',  'IN_STOCK', '2025-02-05 11:00:00', '2026-05-01 09:00:00'),
  ( 3, 14, 1, 'Sony PlayStation 5 Slim + Extra Controller','Sony',    'PS5 Slim console bundle with DualSense controller and 1TB SSD.',               24999.00, 'https://images.unsplash.com/photo-1606144042614-b2417e99c4e3?w=600',  'IN_STOCK', '2025-03-01 09:00:00', '2026-04-20 10:00:00'),
  ( 4, 11, 1, 'Apple iPad Air M2 256GB WiFi',             'Apple',    '11-inch iPad Air with M2 chip, all-day battery, Apple Pencil compatible.',     28500.00, 'https://images.unsplash.com/photo-1544244015-0df4b3ffc6b0?w=600',  'IN_STOCK', '2025-03-10 14:00:00', '2026-03-10 14:00:00'),
  ( 5, 14, 1, 'Samsung 65" QLED 4K Smart TV 2025',        'Samsung',  '65-inch QLED TV with Neo Quantum Processor 4K, Tizen OS, 120Hz.',             32000.00, 'https://images.unsplash.com/photo-1593359677879-a4bb92f829d1?w=600',  'IN_STOCK', '2025-04-01 10:00:00', '2026-04-01 10:00:00'),
  ( 6, 14, 1, 'Sony WH-1000XM6 Wireless Headphones',      'Sony',     'Industry-leading noise cancelling headphones, 30hr battery, multipoint BT.',   9800.00, 'https://images.unsplash.com/photo-1618366712010-f4ae9c647dcb?w=600',  'IN_STOCK', '2025-04-15 11:00:00', '2026-05-01 11:00:00'),
  ( 7, 11, 1, 'Lenovo ThinkPad X1 Carbon Gen 12',         'Lenovo',   'Ultralight business laptop, Intel Core Ultra 7, 32GB RAM, 1TB SSD.',           72000.00, 'https://images.unsplash.com/photo-1588872657578-7efd1f1555ed?w=600',  'IN_STOCK', '2025-05-01 09:00:00', '2026-04-10 09:00:00'),

  -- Fashion (seller: Menna Boutique #12)
  ( 8, 12, 2, 'Linen Summer Maxi Dress - Floral Print',   'Menna''s', 'Breathable 100% linen dress, available in S/M/L/XL, 5 color options.',           650.00, 'https://images.unsplash.com/photo-1572804013309-59a88b7e92f1?w=600',  'IN_STOCK', '2025-03-20 10:00:00', '2026-04-05 10:00:00'),
  ( 9, 12, 2, 'Men''s Slim-Fit Chino Pants',              'Menna''s', 'Stretch cotton chino trousers, 6 colors, waist sizes 28-40.',                     420.00, 'https://images.unsplash.com/photo-1624378439575-d8705ad7ae80?w=600',  'IN_STOCK', '2025-04-01 11:00:00', '2026-04-01 11:00:00'),
  (10, 12, 2, 'Leather Ankle Boots - Women',              'Menna''s', 'Genuine leather ankle boots, cushioned insole, sizes 36-42.',                    1200.00, 'https://images.unsplash.com/photo-1543163521-1bf539c55dd2?w=600', 'IN_STOCK', '2025-04-10 14:00:00', '2026-03-15 14:00:00'),
  (11, 12, 2, 'Classic Denim Jacket - Unisex',            'Menna''s', '100% cotton denim jacket, washed finish, available in 3 shades.',                 780.00, 'https://images.unsplash.com/photo-1576995853123-5a10305d93c0?w=600', 'IN_STOCK', '2025-05-01 09:00:00', '2026-04-20 09:00:00'),

  -- Handmade & Crafts (seller: Salma Crafts #15)
  (12, 15, 7, 'Handmade Leather Tote Bag - Caramel',      'Salma''s Crafts', 'Hand-stitched genuine leather tote, reinforced handles, interior pocket.',  2200.00, 'https://images.unsplash.com/photo-1590874103328-eac38a683ce7?w=600', 'IN_STOCK', '2025-04-05 10:00:00', '2026-05-01 10:00:00'),
  (13, 15, 7, 'Macramé Wall Hanging - Boho 80cm',         'Salma''s Crafts', 'Hand-knotted cotton macramé art, 80cm wide, natural or dyed variants.',      850.00, 'https://images.unsplash.com/photo-1622237563683-8d6f4b5d6c86?w=600', 'IN_STOCK', '2025-04-20 11:00:00', '2026-04-20 11:00:00'),
  (14, 15, 7, 'Hand-Painted Ceramic Mug Set (4 pcs)',     'Salma''s Crafts', 'Set of 4 hand-painted ceramic mugs, each unique, dishwasher safe.',           600.00, 'https://images.unsplash.com/photo-1514228742587-6b1558fcca3d?w=600', 'IN_STOCK', '2025-05-05 09:00:00', '2026-05-05 09:00:00'),

  -- Home & Furniture
  (15, 11, 3, 'Xiaomi Smart Air Purifier 4 Pro',          'Xiaomi',  'HEPA H13 filter, covers 60m², PM2.5 sensor, app control, ultra-quiet.',           4500.00, 'https://images.unsplash.com/photo-1585771724684-38269d6639fd?w=600', 'IN_STOCK', '2025-03-15 10:00:00', '2026-05-01 10:00:00'),
  (16, 14, 3, 'Philips Airfryer XXL 7.3L',                'Philips', 'Rapid Air technology, 7.3L capacity, 6 cooking presets, fat removal.',            7800.00, 'https://images.unsplash.com/photo-1648733966427-1c01662c2a79?w=600', 'IN_STOCK', '2025-04-01 09:00:00', '2026-04-01 09:00:00'),

  -- Already sold / removed
  (17, 11, 1, 'iPhone 15 Pro Max 256GB Natural Titanium',  'Apple',  'Previous-gen flagship, sold as part of bundle promotion.',                        52000.00, 'https://images.unsplash.com/photo-1695048133142-1a20484d2569?w=600', 'OUT_OF_STOCK',      '2025-01-10 10:00:00', '2026-03-01 12:00:00'),
  (18, 12, 2, 'Overstock Winter Coat Bundle (3 pcs)',      'Menna''s','Bundle listing removed after stock clearance.',                                    3200.00, 'https://images.unsplash.com/photo-1539533113208-f6df8cc8b543?w=600', 'UNAVAILABLE',   '2025-02-01 10:00:00', '2026-02-15 09:00:00');
