...
INSERT INTO products (product_id, seller_id, category_id, name, brand, description, price, image_url, status, created_at, updated_at) VALUES
  ...
  ( 1, 11, 1, 'Samsung Galaxy S25 Ultra 512GB',           'Samsung',  'Flagship smartphone with 200MP camera, S-Pen, 5000mAh battery, AI features.', 45999.00, 'https://cdn.marketplace.com/products/1.jpg',  'IN_STOCK', '2025-02-01 10:00:00', '2026-04-15 12:00:00'),
  ( 2, 11, 1, 'MacBook Pro M4 14-inch 16GB/512GB',        'Apple',    'Professional laptop with M4 chip, Liquid Retina XDR display, 18-hr battery.',  89999.00, 'https://cdn.marketplace.com/products/2.jpg',  'IN_STOCK', '2025-02-05 11:00:00', '2026-05-01 09:00:00'),
  ( 3, 14, 1, 'Sony PlayStation 5 Slim + Extra Controller','Sony',    'PS5 Slim console bundle with DualSense controller and 1TB SSD.',               24999.00, 'https://cdn.marketplace.com/products/3.jpg',  'IN_STOCK', '2025-03-01 09:00:00', '2026-04-20 10:00:00'),
  ( 4, 11, 1, 'Apple iPad Air M2 256GB WiFi',             'Apple',    '11-inch iPad Air with M2 chip, all-day battery, Apple Pencil compatible.',     28500.00, 'https://cdn.marketplace.com/products/4.jpg',  'IN_STOCK', '2025-03-10 14:00:00', '2026-03-10 14:00:00'),
  ( 5, 14, 1, 'Samsung 65" QLED 4K Smart TV 2025',        'Samsung',  '65-inch QLED TV with Neo Quantum Processor 4K, Tizen OS, 120Hz.',             32000.00, 'https://cdn.marketplace.com/products/5.jpg',  'IN_STOCK', '2025-04-01 10:00:00', '2026-04-01 10:00:00'),
  ( 6, 14, 1, 'Sony WH-1000XM6 Wireless Headphones',      'Sony',     'Industry-leading noise cancelling headphones, 30hr battery, multipoint BT.',   9800.00, 'https://cdn.marketplace.com/products/6.jpg',  'IN_STOCK', '2025-04-15 11:00:00', '2026-05-01 11:00:00'),
  ( 7, 11, 1, 'Lenovo ThinkPad X1 Carbon Gen 12',         'Lenovo',   'Ultralight business laptop, Intel Core Ultra 7, 32GB RAM, 1TB SSD.',           72000.00, 'https://cdn.marketplace.com/products/7.jpg',  'IN_STOCK', '2025-05-01 09:00:00', '2026-04-10 09:00:00'),

  -- Fashion (seller: Menna Boutique #12)
  ( 8, 12, 2, 'Linen Summer Maxi Dress - Floral Print',   'Menna''s', 'Breathable 100% linen dress, available in S/M/L/XL, 5 color options.',           650.00, 'https://cdn.marketplace.com/products/8.jpg',  'IN_STOCK', '2025-03-20 10:00:00', '2026-04-05 10:00:00'),
  ( 9, 12, 2, 'Men''s Slim-Fit Chino Pants',              'Menna''s', 'Stretch cotton chino trousers, 6 colors, waist sizes 28-40.',                     420.00, 'https://cdn.marketplace.com/products/9.jpg',  'IN_STOCK', '2025-04-01 11:00:00', '2026-04-01 11:00:00'),
  (10, 12, 2, 'Leather Ankle Boots - Women',              'Menna''s', 'Genuine leather ankle boots, cushioned insole, sizes 36-42.',                    1200.00, 'https://cdn.marketplace.com/products/10.jpg', 'IN_STOCK', '2025-04-10 14:00:00', '2026-03-15 14:00:00'),
  (11, 12, 2, 'Classic Denim Jacket - Unisex',            'Menna''s', '100% cotton denim jacket, washed finish, available in 3 shades.',                 780.00, 'https://cdn.marketplace.com/products/11.jpg', 'IN_STOCK', '2025-05-01 09:00:00', '2026-04-20 09:00:00'),

  -- Handmade & Crafts (seller: Salma Crafts #15)
  (12, 15, 7, 'Handmade Leather Tote Bag - Caramel',      'Salma''s Crafts', 'Hand-stitched genuine leather tote, reinforced handles, interior pocket.',  2200.00, 'https://cdn.marketplace.com/products/12.jpg', 'IN_STOCK', '2025-04-05 10:00:00', '2026-05-01 10:00:00'),
  (13, 15, 7, 'Macramé Wall Hanging - Boho 80cm',         'Salma''s Crafts', 'Hand-knotted cotton macramé art, 80cm wide, natural or dyed variants.',      850.00, 'https://cdn.marketplace.com/products/13.jpg', 'IN_STOCK', '2025-04-20 11:00:00', '2026-04-20 11:00:00'),
  (14, 15, 7, 'Hand-Painted Ceramic Mug Set (4 pcs)',     'Salma''s Crafts', 'Set of 4 hand-painted ceramic mugs, each unique, dishwasher safe.',           600.00, 'https://cdn.marketplace.com/products/14.jpg', 'IN_STOCK', '2025-05-05 09:00:00', '2026-05-05 09:00:00'),

  -- Home & Furniture
  (15, 11, 3, 'Xiaomi Smart Air Purifier 4 Pro',          'Xiaomi',  'HEPA H13 filter, covers 60m², PM2.5 sensor, app control, ultra-quiet.',           4500.00, 'https://cdn.marketplace.com/products/15.jpg', 'IN_STOCK', '2025-03-15 10:00:00', '2026-05-01 10:00:00'),
  (16, 14, 3, 'Philips Airfryer XXL 7.3L',                'Philips', 'Rapid Air technology, 7.3L capacity, 6 cooking presets, fat removal.',            7800.00, 'https://cdn.marketplace.com/products/16.jpg', 'IN_STOCK', '2025-04-01 09:00:00', '2026-04-01 09:00:00'),

  -- Already sold / removed
  (17, 11, 1, 'iPhone 15 Pro Max 256GB Natural Titanium',  'Apple',  'Previous-gen flagship, sold as part of bundle promotion.',                        52000.00, 'https://cdn.marketplace.com/products/17.jpg', 'OUT_OF_STOCK',      '2025-01-10 10:00:00', '2026-03-01 12:00:00'),
  (18, 12, 2, 'Overstock Winter Coat Bundle (3 pcs)',      'Menna''s','Bundle listing removed after stock clearance.',                                    3200.00, 'https://cdn.marketplace.com/products/18.jpg', 'UNAVAILABLE',   '2025-02-01 10:00:00', '2026-02-15 09:00:00');
